...
--
-- Host: localhost
-- Generation Time: Dec 29, 2013 at 05:09 AM
...
--
CREATE DATABASE IF NOT EXISTS `quanlykhachsan` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `quanlykhachsan`;
...
CREATE TABLE IF NOT EXISTS `thuedichvu` (
  `iddichvu` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `thuedichvu` (`iddichvu`, `tendichvu`, `cmnd`, `ngaydung`, `dongia`, `soluong`, `thanhtien`) VALUES
(3, 'dv01', 1806, '2013-10-01', 1, 123, 1),
(4, 'dv02', 1806, '2013-10-01', 1, 3245, 12313),
(5, 'dv01', 1806, '2013-10-01', 1, 3245, 3245),
(6, 'dv01', 1806, '0000-00-00', 1, 123, 123),
(7, 'dv01', 23568977, '2013-10-01', 100, 123, 12300),
(8, '', 1806, '0000-00-00', 0, 0, 0),
(9, '', 1806, '0000-00-00', 0, 0, 0),
(10, 'dv01', 36058, '2013-10-01', 1, 123, 123);
...
INSERT INTO `thuephong` (`idphong`, `cmnd`, `ngayden`, `ngaydi`) VALUES
(1, 2, '2013-12-27', '2013-12-27'),
(9, 5, '2013-12-14', '2013-12-14'),
(36058, 1, '0000-00-00', '0000-00-00'),
(1806, 2, '0000-00-00', '0000-00-00');
...
(1, 'Super Admin', 'a:10:{i:0;s:2:"22";i:1;s:1:"2";i:2;s:1:"3";i:3;s:1:"8";i:4;s:1:"9";i:5;s:2:"10";i:6;s:2:"11";i:7;s:2:"14";i:8;s:2:"13";i:9;s:2:"15";}', '123'),
